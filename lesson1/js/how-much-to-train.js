...
alert('Исходя из количества отведанного и длительности почивания, Вам, господин, необходима следующая физическая нагрузка: прыжков - ' + jumps + ', подтягиваний - ' + pulls + ', кругов пробежки - ' + runs);