/*
Добавим код для сортировки массива. 
Добавим код для вычисления медианы.

И останется только вывести значение медианного значения в консоль, чтобы Кекс увидел, как оно отличается от среднего значения.
*/
